...
from keras.layers import Dense, AlphaDropout, Activation, Flatten
...
model.add(Conv2D(32, (3, 3), padding='same', input_shape=x_train.shape[1:], kernel_initializer='lecun_normal',
