...
#tf.scalar_summary('loss', cost)  # removed after tf 0.12
tf.summary.scalar('loss', cost)
# Create a summary to monitor accuracy tensor
#tf.scalar_summary('accuracy', acc)
tf.summary.scalar('accuracy', acc)
# Merge all summaries into a single op
#merged_summary_op = tf.merge_all_summaries()  # removed after 0.12
...
with tf.Session() as sess:
    ...
    #summary_writer = tf.train.SummaryWriter(logs_path, graph=tf.get_default_graph())  # removed
