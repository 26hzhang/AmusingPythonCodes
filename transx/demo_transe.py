...
import os
import ctypes
from models.transe_model import TransE
...
# build model
transe = TransE(entity_size, relation_size, hidden_size, margin=1.0, learning_rate=0.001, l1_flag=True)

# train model
# sess = transe.train(lib, num_steps=500, batch_size=batch_size, sess=None)

# test model
transe.test(test_lib, sess=None)
