...
import os
import ctypes
from models.transh_model import TransH
...
# build model
transh = TransH(entity_size, relation_size, hidden_size, margin=1.0, learning_rate=0.001, l1_flag=True)

# train model
sess = transh.train(lib, num_steps=500, batch_size=batch_size, sess=None)

# test model
transh.test(test_lib, sess=None)
